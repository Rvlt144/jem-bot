...
*/
const BotName = '👾JEM-BOT👾'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/revolt_144'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/+6283164445159'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan Cok'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/KBt8lh74kvUJ6gunrVkco4'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://www.youtube.com/channel/UCH1CF2_cQ-bseuB46M04_kw'; // OFFICIAL GRUP LU 2
const grupch3 = 'https://instagram.com/revolt_144'; // OFFICIAL GRUP LU 3
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] ReVolt Ready scan now!`);
});
...
conn.sendMessage(id, 'salam juga, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'Syalom'){
conn.sendMessage(id, 'Syaloom Juga Sahabat Terkasih, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'Shaloom'){
conn.sendMessage(id, 'Shaloom Juga Sahabat Terkasih, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'p'){
conn.sendMessage(id, 'Dilarang "P" Ucapkan Salam Terlebih Dahulu Misalnya Syalom atau Assalamualaikum, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Dilarang "P" Ucapkan Salam Terlebih Dahulu Misalnya Syalom atau Assalamualaikum, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner Rico Sinurat wa.me/+6283164445159' ,MessageType.text);
}
else if (text == 'Rico'){
conn.sendMessage(id, 'Aku BOT nya Rico Sinurat (ReVolt)' ,MessageType.text);
}
...
conn.sendMessage(id, 'Haloo, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Apa Woii?!!, Ketik !menu/!info/!donasi Contoh !help' ,MessageType.text);
}
else if (text == 'Eoy'){
conn.sendMessage(id, 'Ya?, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Apa Sayang ?, Ketik !help/!info/!donasi Contoh !help' ,MessageType.text);
}
...
`,
 MessageType.text);
    ...
    var namamu = gh.split("dan")[0];
    var pasangan = gh.split("dan")[1];
    request.get({
        headers: {'content-type' : 'application/x-www-form-urlencoded'},
...
//SCRIPT DIBUAT OLEH Aris187 ID dan Di REEDIT REVOLT
